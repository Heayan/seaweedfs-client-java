...
import com.heayan.seaweedfs.exception.SeaweedfsFileNotFoundException;
...
public class VolumeWrapper {
    ...
    public long uploadFile(String url, String fid, String fileName, InputStream stream, String ttl,
        ...
        //如果上传为图片，此处并无size值
        Object size = objectMapper.readValue(jsonResponse.json, Map.class).get("size");
        return size==null?new Integer(0): (Integer)size;
    }
